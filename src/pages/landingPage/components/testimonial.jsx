      ...
      <div className="md:w-full md:flex text-[#0b1321] gap-6 h-full borde">
        ...
        <div className="md:w-1/3 h-full bg-white  mb-5 md:mb-0 flex flex-col justify-between gap-4 p-10 rounded-xl borde">
          ...
          <p className="text-lg font-light">
            Working with TechUni has been a game-changer for our business. Their
            website development services transformed our online presence, and
            the tech training sessions equipped our team.
          </p>
        </div>
        <div className="md:w-1/3 h-full bg-white mb-5 md:mb-0 flex flex-col justify-between gap-4 p-10 rounded-xl borde ">
          <div className="flex justify-betwen items-center gap-4 borde">
        ...
        <div className="md:w-1/3 h-full bg-white mb-5 md:mb-0 flex flex-col justify-between gap-4 p-10 rounded-xl borde ">
          ...
          <p className="text-black text-lg font-light">
            WTechUni's tech training program was incredible! The instructors
            were knowledgeable and approachable, making complex topics easy to
            understand. I gained practical skills in coding.
          </p>
        </div>
      </div>
    </div>
