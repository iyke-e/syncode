...
export const TeamCards = [
  {
    ...
    socials: [<FaTwitter key={1} />, <FaLinkedin key={2} />],
  },
  {
    id: 2,
    passport: courtney,
...
export const Testimonial = [
  {
    ...
    rate: 4.8,
    testimony:
      "TechUni's tech training program was incredible! The instructors were knowledgeable and approachable, making complex topics easy to understand. I gained practical skills in coding.",
  },
  {
    id: 2,
    image: song,
