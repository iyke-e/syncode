...
import image from "../../assets/TechUni-course.png";
    ...
    <div className=" w-screen grid gap-12 px-6 md:px-20 pb-10">
      <section className=" w-full grid md:grid-cols-2 gap-9 md:gap-16 lg:gap-20 py-8 mb-4 items-center justify-between border-b border-[#E4E4E7]">
        ...
        <p className="text-base text-[#59595A] font-normal text-wrap">
          Unlock the power of data with TechUni's comprehensive Data Analysis
          course. Designed for aspiring analysts and professionals looking to
          enhance their skills, our course covers everything from data
          collection and cleaning to advanced analytical techniques and
          visualization.
        </p>
      </section>
      ...
      <section className="w-full relative">
        <img
          src={image}
          className="w-full aspect-video object-fit border-8 rounded-xl border-[#E4E4E4FF]"
          alt="image"
        />
        <div className="absolute top-0 left-0 #00000080 flex items-center justify-center h-full w-full">
          ...
          >
            ...
            />
            <path
              d="M24.7097 19.329C23.0117 18.2585 20.7998 19.4788 20.7998 21.4861V41.514C20.7998 43.5214 23.0117 44.7417 24.7097 43.6712L40.594 33.6572C42.1807 32.6568 42.1807 30.3433 40.594 29.343L24.7097 19.329Z"
              fill="white"
            />
          </svg>
        </div>
      ...
      <Link
        to="/courses/data/apply"
        className="justify-self-center py-7 my-16 px-20 bg-[#1B40B3] flex gap-3 items-center rounded-2xl font-bold text-white text-xl outline-0"
      >
        Apply Now
        <svg
          width="28"
        ...
        >
          <g clip-path="url(#clip0_145_575)">
            <path
              d="M4.26318 14.5983H23.0256"
              stroke="white"
              stroke-width="2.27423"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M15.3501 6.92273L23.0256 14.5983L15.3501 22.2738"
              stroke="white"
              stroke-width="2.27423"
              stroke-linecap="round"
              stroke-linejoin="round"
          ...
          <defs>
            <clipPath id="clip0_145_575">
              <rect
                ...
                height="27.2908"
                fill="white"
                transform="translate(-0.000976562 0.952637)"
              />
            </clipPath>
          </defs>
        </svg>
